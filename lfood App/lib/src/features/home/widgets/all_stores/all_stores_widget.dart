    ...
    return ListView(
      children: [
        CategoryListWidget(
          items: [
            CategoryListItem(
                ...
                label: 'Restaurantes',
                imageUrl:
                    'https://bambini.com.br/wp-content/uploads/2018/12/produto_Bambini_2-169.png'),
            CategoryListItem(
                onTap: (item) {
            ...
            CategoryListItem(
                ...
                label: 'Clube Lfood',
                imageUrl:
                    'https://www.pngkey.com/png/full/817-8171038_https-pbs-twimg-com-profile-h7-cartoon.png'),
            CategoryListItem(
                onTap: (item) {
                  Navigator.of(context).push(
                    MaterialPageRoute(
        ...
        const CouponsAndNewsWidget(
          imageList: [
            'https://static.ifood-static.com.br/image/upload/t_high/discoveries/0103marcasfamosas35offprincipal_gP6n.png?imwidth=1920',
