/*
This function is used for draw custom marker icon on the google maps using _images assets
 */
...
class CustomIconAssets extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawImage(_image, Offset(size.width/2-_image.width/2, size.height), paint2);
  }
