...
class EditGeofencePage extends StatefulWidget {
  final int geoId;

  const EditGeofencePage({Key? key, this.geoId = 0}) : super(key: key);

  @override
  _EditGeofencePageState createState() => _EditGeofencePageState();
}

class _EditGeofencePageState extends State<EditGeofencePage> {
  late int _dataIndex;
  ...
  TextEditingController _etGeofenceName = TextEditingController();
  TextEditingController _etGeofenceDesc = TextEditingController();
  ...
  */
  ...
  @override
  void initState() {
    // get coupon data index from coupon id
    _dataIndex = geofenceData.indexWhere((data) => data.id==widget.geoId);

    _position = LatLng(geofenceData[_dataIndex].geoLat, geofenceData[_dataIndex].geoLong);
    _etGeofenceName = TextEditingController(text: geofenceData[_dataIndex].geoName);
    _etGeofenceDesc = TextEditingController(text: geofenceData[_dataIndex].geoDesc);
    _valRadius = geofenceData[_dataIndex].geoRad;
  ...
  @override
  void dispose() {
    _etGeofenceName.dispose();
    _etGeofenceDesc.dispose();
    _timerDummy?.cancel();
    super.dispose();
  }
  ...
  void _onGeoChanged(CameraPosition _position) {
