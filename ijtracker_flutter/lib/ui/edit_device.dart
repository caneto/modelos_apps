...
class _EditDevicePageState extends State<EditDevicePage> {
  TextEditingController _etGpsName = TextEditingController();
  TextEditingController _etGpsDesc = TextEditingController();
  TextEditingController _etGpsPhone = TextEditingController();
  bool _valSwitch = true;
  late IconValue _icon;

  @override
  void initState() {
    _etGpsName = TextEditingController(text: deviceData[0].devName);
    _etGpsDesc = TextEditingController(text: deviceData[0].devDesc);
    _etGpsPhone = TextEditingController(text: '+62811456789');
            ...
            children: <Widget>[
              ...
              Container(
                child: TextButton(
                    ...
                    onPressed: () {
                      startLoading(context, 'Edit Device Success', true);
                    },
                    child: Padding(
